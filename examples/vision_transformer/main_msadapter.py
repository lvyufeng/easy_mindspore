...
import msadapter.torchvision as torchvision
from msadapter.torchvision.transforms import Compose, ToTensor, Resize
...
def main():
    ...
    criterion = mindspore.nn.SoftmaxCrossEntropyWithLogits(True, 'mean')
